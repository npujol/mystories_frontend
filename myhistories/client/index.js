...
* <pre>
* var MyHistoriesApi = require('index'); // See note below*.
* var xxxSvc = new MyHistoriesApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new MyHistoriesApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new MyHistoriesApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new MyHistoriesApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
